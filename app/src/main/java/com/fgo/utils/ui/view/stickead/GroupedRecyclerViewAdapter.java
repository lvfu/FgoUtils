package com.fgo.utils.ui.view.stickead;
...
public abstract class GroupedRecyclerViewAdapter
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if (type == TYPE_HEADER) {
            ...
            if (position == getItemCount() - 1) { //如果是最后一条就加footview，传flag为true
                onBindFooterViewHolder((BaseViewHolder) holder, groupPosition, true);
            } else {
                onBindFooterViewHolder((BaseViewHolder) holder, groupPosition, false);
            }
    ...
    public int getFooterViewType(int groupPosition) {
        ...
        Log.e("foot", groupPosition + "===" + getItemCount());
        return TYPE_FOOTER;
    ...
    public abstract int getTypeEmpty(int viewType);

    public abstract void onBindHeaderViewHolder(BaseViewHolder holder, int groupPosition);

    public abstract void onBindFooterViewHolder(BaseViewHolder holder, int groupPosition, boolean flag);

    public abstract void onBindChildViewHolder(BaseViewHolder holder,
                                               int groupPosition, int childPosition);

    public abstract void onBindEmptyViewHolder(BaseViewHolder holder,
                                               int groupPosition);
